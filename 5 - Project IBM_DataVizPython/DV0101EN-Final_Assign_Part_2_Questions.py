...
app.layout = html.Div([
    ...
    html.H1("Automobile Statistics Dashboard", style={'text-align': 'center', 'color': '#333333'}),  # May include style for title
    ...
    html.Div([#TASK 2.3: Add a division for output display
        html.Div(id='output-container', className='output-style', style={'margin-top': '20px'}),
    ])
])
# TASK 2.4: Creating Callbacks
# Define the callback function to update the input container based on the selected statistics
@app.callback(
    Output(component_id='output-display', component_property='children'),
...
@app.callback(
    ...
    [Input(component_id='dropdown1', component_property='value'), Input(component_id='select-year', component_property='value')]
)
...
def update_output_container(selected_statistics, input_year):
    ...
    # Yearly Statistic Report Plots
    elif input_year and selected_statistics == selected_statistics:
        ...
        Y_chart1 = dcc.Graph(figure=px.line(
            ...
            x='Year',
            y='Automobile_Sales',
            title=f"Yearly Average Automobile Sales for the whole period"
        ))
